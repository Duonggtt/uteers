<template>
  <div class="min-h-screen w-full overflow-x-hidden">
    ...
    <section class="min-h-screen bg-gradient-to-br from-gray-50 to-white py-32">
      <div class="w-full px-12 sm:px-16 lg:px-24 xl:px-32 2xl:px-40">
        <div class="max-w-6xl mx-auto">
          ...
          <div class="text-center mb-20">
            ...
            <div class="w-24 h-1 bg-gradient-to-r from-amber-400 to-green-500 mx-auto mb-8"></div>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Nội dung đang được thiết kế lại...
            </p>
          </div>
          
          <!-- Content will be added here -->
          <div class="text-center py-20">
            <div class="w-32 h-32 bg-gradient-to-br from-amber-400 to-green-500 rounded-full flex items-center justify-center mx-auto mb-8">
              <svg class="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
              </svg>
            </div>
            <p class="text-gray-500 text-lg">Trang giấy chứng nhận đang được thiết kế lại...</p>
          </div>
        </div>
      </div>
    </section>
